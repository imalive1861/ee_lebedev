package com.accenture.flowershop.shop.test.clients.ws;

import com.accenture.flowershop.shop.services.ws.FlowersStockWebService;import com.accenture.flowershop.shop.services.ws.FlowersStockWebService;
    ...
    static class AddFlowers extends TimerTask {
        ...
        private void add(int num) throws MalformedURLException {
            ...
            QName SERVICE_NAME = new QName(
                    "http://ws.services.shop.flowershop.accenture.com/", "FlowersStockWebServiceImplService");
