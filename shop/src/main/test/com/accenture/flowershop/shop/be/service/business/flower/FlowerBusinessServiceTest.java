package com.accenture.flowershop.shop.be.service.business.flower;

import com.accenture.flowershop.shop.be.entity.Flower;
import com.accenture.flowershop.shop.be.utils.config.spring.AppConfig;
import com.accenture.flowershop.shop.be.utils.config.spring.ApplicationConfig;
import com.accenture.flowershop.shop.be.utils.config.spring.MVCConfig;
import com.accenture.flowershop.shop.be.utils.config.spring.WebConfig;
import com.accenture.flowershop.shop.be.entity.Flower;
import com.accenture.flowershop.shop.be.utils.config.spring.AppConfig;
import com.accenture.flowershop.shop.be.utils.config.spring.ApplicationConfig;
import com.accenture.flowershop.shop.be.utils.config.spring.WebConfig;
...
public class FlowerBusinessServiceTest {
    ...
    public void update_333_flowerWith333NumberReturned(){
        ...
        Assert.assertEquals(flowerBusinessService.get(flower.getId()).getNumber().intValue(),333);
    }
